...
if __name__ == '__main__':
    ...
    f1_pkt6 = Ether(dst='00:00:0a:00:02:02', src=get_if_hwaddr(iface)) / IP(dst=dst_addr) / TCP(dport=1026, sport=1080) / '\x0a\x0a\x0a\x0a'
    sendp(f1_pkt6, iface = iface)

    f2_pkt6 = Ether(dst='00:00:0a:00:02:02', src=get_if_hwaddr(iface)) / IP(dst=dst_addr) / TCP(dport=9998, sport=1080) / '\x0a\x0a\x0a\x0a'
    sendp(f2_pkt6, iface = iface)